    ...
    <>
      ...
      >
        {/* <div className="w-5/6 mx-auto h-full flex items-center">
          <div className="text-white">
            ...
            <h2 className="text-[52px]">
              Desa Sumberngepoh <br /> 
              Kec. Lawang, Jawa Timur
            </h2>
          </div>
        </div> */}
        ...
        <div className="bg-black bg-opacity-30 flex justify-center items-left flex-col pl-24 font-semibold text-white text-2xl h-screen">
          <h1 className="animate-text bg-gradient-to-r from-white via-primary-500 to-orange-500 bg-clip-text text-transparent text-5xl font-black mt-10">
            Selamat Datang!
          </h1>
          <h1>Desa Sumberngepoh</h1>
          <h1>Kecamatan Lawang, Kabupaten Malang</h1>
          <h1>Jawa Timur</h1>
        </div>
      </div>
      </section>
          ...
          <div className="w-full flex justify-between gap-44">
            <div className="w-3/5">
              <h1 className="text-[44px] text-accent font-semibold mb-6">
                Visi dan Misi Desa Sumberngepoh
              </h1>
            ...
            <div className="w-2/5 h-full">
              <img
                src={visiMisi}
                alt="about"
                className="w-full h-full object-cover object-center mt-40 rounded-lg shadow-xl"
              />
            </div>
          </div>
        </div>
        ...
        <div className="w-5/6 py-[120px] mx-auto">
          <div className="w-full text-primary mb-10">
            ...
            <h2 className="text-2xl text-center">
              Dapatkan Informasi update seputar Kegiatan Desa Sumberngepoh disini.
            </h2>
          </div>
      ...
      >
        <div className="w-5/6 py-[120px] mx-auto">
          <div className="w-full text-secondary mb-10">
            ...
            <h2 className="text-[44px] font-medium">Desa Sumberngepoh</h2>
          </div>
